...
function Init()
  ...
  waypointWP:add(0, 150, -20)
  waypointWP:add(20, 150, 0)
  waypointWP:add(-20, 150, -20)
  
  
  basePoint = vec3.New()
  basePoint:Set(0, 150, 0)
...
function Update(dt)
  ...
  if(state == DINOHEAD_FSM.WALK or state == DINOHEAD_FSM.DINOIDLE) then
    ...
    headLookingDir = (waypointPos - myHeadPos) * 10.0
    OWN.getDinoAI.setDinoHeadLookingDir(headLookingDir.x,0, headLookingDir.z)
